...
---------------------
Produces two separate 2×2 figures, one per fjord case study: Ikerasaap Sullua (QIM) and Kangerluluk (KLU).
...
def make_fjord_figure(
    ...
    out_path  = output_dir / f"{safe_name}_2x2_IGS_renamed.png"
...
def main():
    ...
    make_fjord_figure(
        fjord_name   = "Ikerasaap Sullua (2016)",
